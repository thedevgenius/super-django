...
class Business(models.Model):
    ...
    # Category and Type
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name='businesses', limit_choices_to={'level': 1})
    subcategories = models.ManyToManyField(Category, blank=True, related_name='subcategorized_businesses', limit_choices_to={'level__gt': 0})
